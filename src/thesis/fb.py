...
#                 [1436550136, 100001392610551, 1040476565, 100000050158456, 1535572062, 100000761276531, 100000626047119, 100000204317377, 711597283, 100001159501558, 704756495, 100000070382409], # inni
#                 [100000575211956, 100000943723935, 100000717948818, 1069035901, 100000577456753, 1341833543, 100000586940753], # rodzina
#                 [1198502305, 100000036955024, 100000522020215, 1621747250, 1541512459], #aenima 
...
#            logger.info(self.graph.node[node]['name'] +"  " + str(node)) # z nazwiskami osob
# 
#        
