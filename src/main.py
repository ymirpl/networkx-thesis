...
def experimentOne():
    ...
    (tuple, xaxis) = e.iterateParam(minValue = 10, maxValue = 40, param="size", hardGroupsNo=2, slice_level = 3, step = 5, number = 1, \
                   legible_target_size = 10, VOTERS=500, OBJECTS=100, bad_hideout=False, runsNo = 100)
    ...
    (tuple, xaxis) = e.iterateParam(minValue = 20, maxValue = 100, param="OBJECTS", size = 25, slice_level = 3,  hardGroupsNo=2, step = 20, number = 1, \
                   legible_target_size = 10, VOTERS=500, target_size = 5, bad_hideout=False, runsNo = 100)
    ...
    (tuple, xaxis) = e.iterateParam(minValue = 20, maxValue = 100, param="OBJECTS", size = 25, slice_level = 3,  hardGroupsNo=2, step = 20, number = 1, \
                   legible_target_size = 10, VOTERS=500, target_size = 5, bad_hideout=True, runsNo = 100)
    ...
    (tuple, xaxis) = e.iterateParam(minValue = 300, maxValue = 700, param="VOTERS", size = 25, slice_level = 3,  hardGroupsNo=2, step = 100, number = 1, \
                   legible_target_size = 10, OBJECTS=100, target_size = 5, bad_hideout=False, runsNo = 100)
    ...
    (tuple, xaxis) = e.iterateParam(minValue = 300, maxValue = 700, param="VOTERS", size = 25, slice_level = 3,  hardGroupsNo=2, step = 100, number = 1, \
                   legible_target_size = 10, OBJECTS=100, target_size = 5, bad_hideout=True, runsNo = 100)
